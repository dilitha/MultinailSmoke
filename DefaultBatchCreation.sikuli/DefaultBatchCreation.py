...
def loadTheJobFirst():
    ...
    click("PlaceholderTxt_Jobs_SearchFor.png")
    type("TEST" + Key.ENTER)

    #the exists part was added because, find failed error was displayed otherwise.
    if exists("Job_TCTEST2.png"): a = find("Job_TCTEST2.png").text()
...
def verifyCurrentBatchDropDown(nameOfTheJob):
    ...
    print("Job passed in is : " + nameOfTheJob)
    import shutil
    #Give some time to populate the 'Current Batch' drop-down after finishing the Optimiser
    wait(5)
    #resetImagePath("C:\\Users\\dilitha.vithanage\\Downloads\\Multinail Test Work\\Test Automation\\SikuliX\\My Tests\\MultiControlAutomation\\Images")
    ...
    if exists("DropDownSection_CurrentBatch_TCTEST2.png"):
       #Had to add this 'wait'. Otherwise the image above was not identified correctly.
       wait(1)
       currentBatchSection = find("DropDownSection_CurrentBatch_TCTEST2.png").text() 
